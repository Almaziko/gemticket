...
- Финальные статусы (например, «Готов»/«Отменён») — клиент не может писать в такой тикет.
...
- Админка: клиенты, админы, справочники статусов/трекеров, файлы, шаблоны писем, настройки SMTP.
